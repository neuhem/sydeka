        ...
        <div style={{
          ...
          {(!process.env.NEXT_PUBLIC_SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL === 'https://placeholder.supabase.co') && (
            <div style={{
              ...
              ⚠️ Authentication not configured. Please set up your Supabase environment variables to enable sign-in functionality.
              <br />
          ...
          <p style={{ marginTop: '2rem', color: '#94a3b8', textAlign: 'center' }}>
            Don't have an account? <Link href="/signup" style={{ color: '#60a5fa', textDecoration: 'none' }}>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
